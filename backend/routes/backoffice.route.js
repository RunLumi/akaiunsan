const { headerValidator, backofficeValidator } = require('./../middlewares/validator');
const { recordHistory, checkPermission } = require('../middlewares/admin');

const multer = require('multer');
const { genTxt } = require('../helpers/util');
...
const BizCustomerController = require('../controllers/bizcustomer.controller');
const CleaningSupplyController = require('../controllers/cleaningsupply.controller');
const CustomerController = require('../controllers/customer.controller');
const CustomerSupplyController = require('../controllers/customersupply.controller');
const JobController = require('../controllers/job.controller');
const JobReviewController = require('../controllers/jobreview.controller');
