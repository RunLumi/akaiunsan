...
| `NFR-02` | Bảo mật | Mọi API yêu cầu JWT hợp lệ + header `app_key`; không khóa/mật khẩu/secret nào nằm trong mã nguồn; thẻ tín dụng chỉ lưu 4 số cuối | Rà soát cấu hình, quét mã nguồn, kiểm thử 401 |
