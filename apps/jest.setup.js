...
// react-native-pager-view (the AutoPager host): render pages statically so
// the characterization suites inspect the rendered banners without native
// scroll machinery.
jest.mock("react-native-pager-view", () => {
  const React = require("react");
  const PagerView = ({ children, ...props }) =>
    React.createElement("View", props, children);
  return { __esModule: true, PagerView, default: PagerView };
});
